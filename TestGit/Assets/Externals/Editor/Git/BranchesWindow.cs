...
namespace DTI.SourceControl.Git
{
    public class BranchesWindow : EditorWindow
    {
        ...
        private List<Branch> _selectableBranches;
        ...
        private String SearchLine
        {
            ...
            set
            {
                ...
                {
                    _searchLine = value;
                    _searchBranches = _selectableBranches.Where(x => x.Name.StartsWith(_searchLine));
                }
            }
        }
        ...
        private void InitializeBranches()
        {
            ...
            _selectableBranches = new List<Branch>();
            foreach (var branch in _branches)
            {
                if (_branches.Count(x => x.Name.Equals(branch.Name)) == 1)
                {
                    _selectableBranches.Add(branch);
                    continue;
                }
            ...
            _searchBranches = _selectableBranches;
